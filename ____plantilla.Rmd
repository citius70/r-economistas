...
# RStudio viene con una serie de tablas de ejemplo

data()        # listado de conjuntos de datos disponibles

data(cars)     # Acceso a los datos de cars
head(cars)    # Visualiza las primeras filas del dataframe
tail(cars)     # Visualiza las últimas filas del dataframe
```
...
## Resumen de Funciones para Leer/Importar Datos
...
```
## Leer archivos de texto o tipo tabla

```{r read-table4, eval=FALSE}
